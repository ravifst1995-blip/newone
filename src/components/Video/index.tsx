    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="We Are Ready to Help You Transform Through Technology"
            paragraph="Reliable, scalable, and innovative IT solutions tailored to your business needs — from startups to enterprises."
            center
            mb="80px"
          />
        </div>
